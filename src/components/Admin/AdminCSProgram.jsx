  ...
  const handleDelete = (program) => {
    ...
    return (
        <div className='Materials' >
            ...
            <input type='text' id="CreateProgramObjective" placeholder='Enter Program Objective'></input>
   <button id='miniButton' className="CreateProgramObjectiveButton" onClick={() => handleCreate()}>CREATE PROGRAM OBJECTIVE</button>
        </div>
    );
