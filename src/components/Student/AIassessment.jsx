...
function AIassessment() {
  ...
  useEffect(()=>{
    ...
    const quiz = {
        ...
        questions: [
          {
            // question: 'Artificial Intelligence has evolved extremely in all the fields except for _________',
            // choices: ['Web mining', 'Construction of plans in real time dynamic systems','Understanding natural language robustly', 'All of the above'],
            // type: 'MCQs',
          ...
          },
          {
            ...
            // choices: ['Weak AI approach', 'Applied AI approach', 'Cognitive AI approach', 'Strong AI approach'],
            // type: 'MCQs',
          ...
          {
            // question: 'Which of the following are informed search methods?',
            // choices: ['Best First Search','A* Search','Memory Bound Heuristic Search','All of the above'],
            // type: 'MCQs',
            // correctAnswer: 'All of the above',
    ...
    return (
        <div className='Materials'>
            <h1 id="heading">AI ASSESSMENT</h1>
            <br></br>
